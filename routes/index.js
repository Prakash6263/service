...
const baseAdditionalService = require("../routes/baseAdditionalServiceRoutes")
const cashfreeQR = require("./cashfreeQRRoutes")
...
router.use("/base-additional-service", baseAdditionalService)
...
router.use("/cashfree", cashfreeQR)
